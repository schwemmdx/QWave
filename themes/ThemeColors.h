...
{
        public: 
        static constexpr QColor Background{QColor(39, 40, 34)};   // Dark gray background
        static constexpr QColor Foreground{QColor(248, 248, 242)}; // Light foreground (text)
        static constexpr QColor Highlight{QColor(73, 72, 62)};    // Highlight background
        static constexpr QColor Red{QColor(249, 38, 114)};        // Red (e.g., errors, strings)
        static constexpr QColor Orange{QColor(253, 151, 31)};     // Orange (e.g., function names)
        static constexpr QColor Yellow{QColor(230, 219, 116)};    // Yellow (e.g., constants, variables)
        static constexpr QColor Green{QColor(166, 226, 46)};      // Green (e.g., comments, booleans)
        static constexpr QColor Blue{QColor(102, 217, 239)};      // Blue (e.g., keywords, operators)
        static constexpr QColor Purple{QColor(174, 129, 255)};    // Purple (e.g., special keywords)
};
