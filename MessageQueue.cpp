...
void MessageQueue::addMessage(const QString &text, const QColor &textColor, int timeoutMs, const QIcon &icon) {
    // Create and initialize a new Message object
    Message *newMessage = new Message(text, icon, textColor, timeoutMs, this);
